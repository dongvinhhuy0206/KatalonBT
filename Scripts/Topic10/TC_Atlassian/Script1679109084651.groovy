...
WebUI.mouseOver(findTestObject('Topic10/Atlassian/btn_HoverOverMe'))

'Get hover over background color of button'
String backgroundcolorRGB = WebUI.getCSSValue(findTestObject('Topic10/Atlassian/btn_HoverOverMe'), 'background')
